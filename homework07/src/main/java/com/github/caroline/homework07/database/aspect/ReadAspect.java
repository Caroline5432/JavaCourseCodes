package com.github.caroline.homework07.database.aspect;

import com.github.caroline.homework07.database.datasource.ManagementCenter;
...
public class ReadAspect {
    ...
    @Pointcut("@annotation(com.github.caroline.homework07.database.annotation.ReadAnnotation)")
    public void read(){};
